class CreateUsers < ActiveRecord::Migration[5.2]
  def change #用户
    create_table :users do |t|
      ...
      t.string    :password_digest,  null: false                  # 密码（db/seed，用 password, password_confirmation）
      t.boolean   :admin,            null: false, default: false  # 是否 admin
      t.boolean   :del,              null: false, default: false  # 删除
      t.boolean   :activated,        null: false, default: false  # 是否激活（db/seed）
      t.datetime  :activated_at                                   # 激活时间（db/seed）
